<?php
/**
 * DGTEC — Generic Solution detail page
 * URL: solution-detail.php?slug=<slug>
 */
require_once 'includes/admin-db.php';
require_once 'includes/item-page-renderer.php';

$slug     = trim($_GET['slug'] ?? '');
$_db_item = $slug ? dgtec_item_get_by_slug('solution', $slug) : null;
  ...
  <div class="container">
    <div class="cta-content">
      ...
      <div class="cta-btns">
        ...
        <a href="solutions.php" class="btn btn-outline" style="color:#fff;border-color:rgba(255,255,255,.6);">All Solutions</a>
      </div>
    </div>
  </div>
</section>
