<?php
/**
 * DGTEC Admin — AJAX image upload endpoint for blog posts
 */
...
$ext     = $extMap[$mime];
$fname   = 'blog_' . uniqid('', true) . '.' . $ext;
$destDir = dirname(__DIR__) . '/assets/images/blog/';
$dest    = $destDir . $fname;
...
echo json_encode([
    'success' => true,
    'path'    => 'assets/images/blog/' . $fname,
    'preview' => '../assets/images/blog/' . $fname,
]);
